    ...
    return (
        <div className="parallax-outer">
            <div ref={parallaxRef} style={{ background: `linear-gradient(#0F2B9C, #673D7D ${background}%, #A74A67, #EDFC54 )` }} className='parallax'>
                ...
                <img ref={mountain3} className='mountain-3' src="https://www.frutadeli.com/_nuxt/img/banana.e3feeb3.webp" />
                <img ref={mountain2} className='mountain-2' src="https://www.frutadeli.com/_nuxt/img/leaf-2.adc9187.webp" />
                <img ref={mountain1} className='mountain-1' src="https://www.frutadeli.com/_nuxt/img/leaf.f35bd08.webp" />
                <img ref={sun} className='sun' src="https://www.frutadeli.com/_nuxt/img/logo.7571d51.webp" />
                <img ref={sun} className='sun2' src="/parallax/sun.svg" />
